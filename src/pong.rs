...
impl SimpleState for Pong {
    fn on_start(&mut self, data: StateData<'_, GameData<'_, '_>>) {
        ...
        //world.register::<Paddle>(); // Not needed as PaddleSystem now allocates
        // storage
...
fn initialise_camera(world: &mut World) {
    ...
    transform.translate_xyz(0.0, 0.0, 1.0);
...
fn initialise_ball(world: &mut World, sprite_sheet_handle: SpriteSheetHandle) {
    ...
    local_transform.translate_xyz(ARENA_WIDTH/2.0, ARENA_HEIGHT/2.0, 0.0);
